...
import { Edit3, ArrowLeft, Loader2, Copy, Check, FileCode, ChevronRight, Home, Clock } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background pb-32 selection:bg-indigo-500/10 transition-colors duration-500">
        ...
        <div className="max-w-5xl mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <Button 
              ...
              className="rounded-full hidden sm:flex border-border/60 bg-secondary/20 hover:bg-secondary/40 transition-all font-semibold"
            >
            ...
            <Button 
              ...
              className="rounded-full border-border/60 bg-secondary/20 hover:bg-secondary/40 transition-all font-semibold"
            >
      ...
      <AnimatePresence>
        <motion.div 
          initial={{ y: 100 }}
          animate={{ y: 0 }}
          className="fixed bottom-8 right-8 flex flex-col gap-4 sm:hidden z-50"
        >
           <Button 
            onClick={handleCopyRaw} 
            size="icon" 
            className="w-14 h-14 rounded-full shadow-2xl bg-card border border-border text-foreground hover:bg-accent"
           >
